...
import Kernel.Types.CacheFlow (HasCacConfig, HasCacheConfig, HasInMemConfig)
...
withDynamicLogLevel ::
  (HasLog f, HasCoreMetrics f, HasEsqEnv m f, HedisFlow m f, HasInMemConfig f, HasCacheConfig f, HasSchemaName BeamSC.SystemConfigsT, MonadReader f m, MonadFlow m, HasCacConfig f) =>
  Text ->
  m a ->
  m a
...
getDynamicLogLevelConfig ::
  (HasLog f, HasCoreMetrics f, HasEsqEnv m f, HedisFlow m f, HasInMemConfig f, HasCacheConfig f, HasSchemaName BeamSC.SystemConfigsT, MonadReader f m, MonadFlow m, HasCacConfig f) => m (Maybe (HM.HashMap Text LogLevel))
