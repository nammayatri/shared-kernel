...
import Kernel.Types.CacheFlow (HasCacConfig, HasCacheConfig, HasInMemEnv, HasTxnId)
...
withDynamicLogLevel ::
  (HasLog f, HasCoreMetrics f, HasEsqEnv m f, HedisFlow m f, HasInMemEnv f, HasCacheConfig f, HasSchemaName BeamSC.SystemConfigsT, MonadReader f m, MonadFlow m, HasCacConfig f, HasTxnId f) =>
  Text ->
  m a ->
  m a
...
getDynamicLogLevelConfig ::
  (HasLog f, HasCoreMetrics f, HasEsqEnv m f, HedisFlow m f, HasInMemEnv f, HasCacheConfig f, HasSchemaName BeamSC.SystemConfigsT, MonadReader f m, MonadFlow m, HasCacConfig f, HasTxnId f) => m (Maybe (HM.HashMap Text LogLevel))
