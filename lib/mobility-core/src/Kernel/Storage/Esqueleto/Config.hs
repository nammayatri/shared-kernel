...
type HasEsqEnv m r = (HasEsq m r, HasField "esqDBEnv" r EsqDBEnv, HasField "requestId" r (Maybe Text), HasField "shouldLogRequestId" r Bool, HasField "sessionId" r (Maybe Text))
