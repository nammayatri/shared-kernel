...
generateAplhaNumbericCode :: MonadFlow m => Int -> m (ShortId a)
generateAplhaNumbericCode len = ShortId . T.pack <$> liftIO (RS.randomString (RS.onlyAlphaNum RS.randomASCII) len)
