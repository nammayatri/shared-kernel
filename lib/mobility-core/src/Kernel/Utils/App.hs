...
withModifiedEnv' :: (HasARTFlow f, HasCoreMetrics f, HasField "dbFunctions" f DbFunctions, HasField "esqDBEnv" f EsqDBEnv, HedisFlowEnv f, HasCacheConfig f, HasSchemaName BeamSC.SystemConfigsT) => (EnvR f -> Application) -> EnvR f -> Application
