  ...
  BSL.fromStrict . TE.encodeUtf8 $
    T.concat
      [ "<?xml version=\"1.0\" encoding=\"UTF-8\"?>",
        ...
        "</ins:EWCommencesOn>",
        "<ins:CustomerId>",
        maybe "" xmlEscape req.customerId,
        "</ins:CustomerId>",
        "<ins:ExtraAttrib01>",
        ...
        "</ins:ExtraAttrib02>",
        "<ins:InsuredProductCode>",
        maybe "" xmlEscape req.insuredProductCode,
        "</ins:InsuredProductCode>",
        "<ins:ItemDetail>",
        maybe "" xmlEscape req.itemDetail,
        "</ins:ItemDetail>",
        "<ins:RiskEndDate>",
        ...
        "</ins:RiskStartDate>",
        "<ins:SumInsured>",
        maybe "" (T.pack . show) req.sumInsured,
        "</ins:SumInsured>",
        "</ins:DeclarationDetails>",
        "</ins:INSDeclarationsWebServiceRequestIO>",
        "</cus:RegisterHomeDeclaration_New_Input>",
