...
mkLoyaltyEarnCampaign :: Juspay.EarnCampaign -> Maybe LoyaltyEarnCampaign
mkLoyaltyEarnCampaign Juspay.EarnCampaign {..} = do
  appliedPoints <- applied
  pts <- parseLoyaltyPoints appliedPoints.points
  pure LoyaltyEarnCampaign {campaignId = id, points = pts}
