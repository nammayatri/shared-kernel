...
data SmsService = MyValueFirst | ExotelSms | GupShup | TwillioSms | DigoEngage | VonageSms
...
availableSmsServices = [MyValueFirst, ExotelSms, GupShup, TwillioSms, DigoEngage, VonageSms]
