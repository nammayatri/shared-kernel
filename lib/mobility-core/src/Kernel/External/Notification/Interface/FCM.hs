...
interfaceCategoryToFCMNotificationType = \case
  ...
  Interface.PREPAID_RECHARGE_SUCCESS -> FCM.PREPAID_RECHARGE_SUCCESS
  Interface.PREPAID_BALANCE_UPDATE -> FCM.PREPAID_BALANCE_UPDATE
  Interface.PAYOUT_INITIATED -> FCM.PAYOUT_INITIATED
  Interface.PAYOUT_FAILED -> FCM.PAYOUT_FAILED
  Interface.PAYOUT_COMPLETED -> FCM.PAYOUT_COMPLETED
  ...
  Interface.FLEET_REQUEST_APPROVED -> FCM.FLEET_REQUEST_APPROVED
  Interface.FLEET_REQUEST_REJECTED -> FCM.FLEET_REQUEST_REJECTED
  ...
  Interface.REFUND_REQUEST_APPROVED -> FCM.REFUND_REQUEST_APPROVED
